...
const Customer = ({ onSubmitSuccess }) => {
    ...
    onSubmit: async (values, { setFieldError, resetForm }) => {
      try {
        ...
        if (response.data.error) {
          ...
          if (errorMessage.includes('customer code already exists')) {
            setFieldError("customerCode", "Customer Code already exists");
          }
  ...
  return (
    <Paper elevation={3} className="customer-paper">
      <Typography variant="h5" gutterBottom className="customer-heading">
        Create Customer
      </Typography>

      <Box className="customer-form-container">
        <Box className="customer-form-field">
          <TextField
            label="Name"
            variant="outlined"
            fullWidth
              ...
              <div>
                <TextField
                  ...
                  inputProps={{
                   ...
                   value={formik.values.country ? formik.values.country.label : ''}
                 //error={formik.touched.country && Boolean(formik.errors.country)}
                  //helperText={formik.touched.country && formik.errors.country && formik.errors.country.label}
                />
